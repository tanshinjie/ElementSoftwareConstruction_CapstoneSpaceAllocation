...
public class Test {
	public static void main(String[] args) throws InterruptedException {
		...
		imgUpload1.sendKeys("D:\\2dpacking\\Base GUI\\Capstone 2019 Layout_Page_1_clean.png");
		Thread.sleep(2000);
		//b
		WebElement imgUpload2 = driver.findElement(By.id("uploaded-file2"));
		imgUpload2.sendKeys("D:\\2dpacking\\Base GUI\\Capstone 2019 Layout_Page_2._clean.png");
		Thread.sleep(2000);
		//c
		...
		excelUpload.sendKeys("D:\\2dpacking\\2019 Showcase Space and Logistics Requirements_7Aug2019.xlsx");
		//f
		//g
